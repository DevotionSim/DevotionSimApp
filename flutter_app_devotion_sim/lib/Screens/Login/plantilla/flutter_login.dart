...
import 'package:flutter_app_devotion_sim/Screens/Login/plantilla/theme.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/color_helper.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/constants.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/dart_helper.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/models/login_user_type.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/providers/auth.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/providers/login_messages.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/providers/login_theme.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/regex.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/widgets/auth_card.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/widgets/fade_in.dart';
import 'package:flutter_app_devotion_sim/Screens/Login/src/widgets/null_widget.dart';
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 178, 44, 44),
        body: Stack(
          children: <Widget>[
            Container(
                height: 400,
